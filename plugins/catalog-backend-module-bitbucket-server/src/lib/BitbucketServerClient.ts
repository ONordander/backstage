...
export class BitbucketServerClient {
  ...
  }): Promise<PagedResponse<BitbucketServerProject>> {
  ...
  async listRepositories(options: {
    projectKey: string;
    listOptions?: BitbucketServerListOptions;
  }): Promise<PagedResponse<BitbucketServerRepository>> {
    return this.pagedRequest(
...
export async function* paginated(
  request: (options: BitbucketServerListOptions) => Promise<PagedResponse<any>>,
  options?: BitbucketServerListOptions,
) {
